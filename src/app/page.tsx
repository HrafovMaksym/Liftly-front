...
// const OLD_API = "http://localhost:3000/api";
...
export default function Home() {
  ...
  useEffect(() => {
    fetchData("http://localhost:4000/api/workouts").then((data) => {
  ...
  const API_TOKEN = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.secretpayload";
